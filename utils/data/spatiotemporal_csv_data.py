...
class SpatioTemporalCSVDataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs
        ...
        self._dis = utils.data.functions.load_distance_matrix(r'D:\demo\demo-back\Tms-GCN-PyTorch-plus\data\sz_distance.csv')
        self.direct = utils.data.functions.load_distance_matrix(r'D:\demo\demo-back\Tms-GCN-PyTorch-plus\data\sz_direct.csv')
    ...
    def add_data_specific_arguments(parent_parser):
        ...
        parser.add_argument("--pre_len", type=int, default=12)  # 1 3 6 9 12
